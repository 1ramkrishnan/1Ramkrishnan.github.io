...
<style>
  /* hide theme header, nav, footer, and "generated by GitHub Pages" */
  header, .site-header, nav, .navbar, footer, .site-footer,
  .page-header, [role="banner"] { display: none !important; }
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .rk-card:hover { border-color: rgba(29,158,117,0.3); background: rgba(29,158,117,0.04); text-decoration: none; }
  .rk-card:hover::before { background: linear-gradient(90deg, transparent, #1D9E75, transparent); }
  ...
  .rk-cert:hover { border-color: rgba(29,158,117,0.3); background: rgba(29,158,117,0.04); text-decoration: none; }
  ...
  .rk-cert-name { font-size: 13px; color: #cbd5e1; font-weight: 500; }
  ...
  @media (max-width: 600px) {
    .rk-header { flex-direction: column-reverse; gap: 1rem; }
    .rk-avatar-ring { width: 72px; height: 72px; }
  }
</style>
